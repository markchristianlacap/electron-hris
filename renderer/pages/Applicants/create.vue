            ...
            <el-row>
              <el-col :span="24" v-for="{ level, label } in levels" :key="level">
                <el-form-item :label="label">
                  <el-row class="grid">
                    <el-col
                      v-for="{ span, type, model, placeholder, format } in schoolFields"
                      :key="model"
                      :span="span"
                    >
                      <el-form-item>
          ...
          <el-tab-pane label="Family Background">
            ...
            <el-form-item label="Father's name">
              <el-row :gutter="4">
                ...
                <el-col :span="6">
                  <el-input v-model="form.father.name.middle" placeholder="Middle name"></el-input>
                </el-col>
                <el-col :span="3">
            ...
            <el-form-item label="Mother's name">
              <el-row :gutter="4">
                ...
                <el-col :span="7">
                  <el-input v-model="form.mother.name.middle" placeholder="Middle name"></el-input>
                </el-col>
              </el-row>
            </el-form-item>
            ...
            <el-form-item label="Full name">
              <el-row :gutter="4">
                ...
                <el-col :span="6">
                  <el-input v-model="form.spouse.name.middle" placeholder="Middle name"></el-input>
                </el-col>
                <el-col :span="3">
